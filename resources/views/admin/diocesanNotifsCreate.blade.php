        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <a href="/admin/diocesannotifs" class="btn btn-primary btn-sm">View</a><br /><br />
                    ...
                    <div>
                        <form action="{{action('Admin\DiocesanNotifsController@store')}}" method="post" enctype="multipart/form-data" id="post_form">
