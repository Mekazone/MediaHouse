    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Opinion</div>
                ...
                <div class="panel-body">
                    ...
                    <table class="news_links">
                        <tr><td><a href="{{ action('Admin\OpinionController@edit', $result->id) }}" class="btn btn-primary btn-sm">Edit</a></td>
                        <td>{{ Form::open(['method' => 'delete', 'route' => ['opinion.destroy', $result->id]])}} {{ Form::submit('Delete', ['class' => 'btn btn-sm btn-danger', 'onclick' => 'return confirm("Are you sure you want to delete?")']) }} {{Form::close() }}</td>
                        @if($topImage)
                            @if($featureCount > 0)
                                @if($featured == 'yes')
