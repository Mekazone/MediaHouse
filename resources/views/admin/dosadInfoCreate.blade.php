    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">DOSAD Info &amp; Notifs</div>
                ...
                <div class="panel-body">
                    ...
                    <a href="/admin/dosadinfo" class="btn btn-primary btn-sm">View</a><br /><br />
                    ...
                    <div>
                        <form action="{{action('Admin\DosadNotifsController@store')}}" method="post" enctype="multipart/form-data" id="post_form">
