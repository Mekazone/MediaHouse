        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <a href="/admin/news" class="btn btn-primary btn-sm">View</a><br /><br />
                    ...
                    <div>
                        <form action="{{action('Admin\NewsController@store')}}" method="post" enctype="multipart/form-data" id="post_form">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="keywords" id="keywords" placeholder="Enter keywords, each seperated with a comma" required="">
                            </div>
