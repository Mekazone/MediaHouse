            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <table class="news_links">
                        <tr><td><a href="{{ action('Admin\InspirationController@edit', $result->id) }}" class="btn btn-primary btn-sm">Edit</a></td>
                        <td>{{ Form::open(['method' => 'delete', 'route' => ['inspirational.destroy', $result->id]])}} {{ Form::submit('Delete', ['class' => 'btn btn-sm btn-danger', 'onclick' => 'return confirm("Are you sure you want to delete?")']) }} {{Form::close() }}</td>
