        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div>
                        <form action="{{action('Admin\ContactController@store')}}" method="post" enctype="multipart/form-data">
                    ...
                    @else
                    <a href="{{ action('Admin\ContactController@edit', $slug) }}" class="btn btn-primary btn-sm">Edit</a><br /><br /> 
