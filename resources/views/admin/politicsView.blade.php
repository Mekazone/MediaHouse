        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <tr><td><a href="{{ action('Admin\PoliticsController@edit', $result->id) }}" class="btn btn-primary btn-sm">Edit</a></td>
                    <td>{{ Form::open(['method' => 'delete', 'route' => ['politics.destroy', $result->id]])}} {{ Form::submit('Delete', ['class' => 'btn btn-sm btn-danger', 'onclick' => 'return confirm("Are you sure you want to delete?")']) }} {{Form::close() }}</td>
