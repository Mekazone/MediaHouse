...
<div id="subscription" class="modal fade" role="dialog">
  <div class="modal-dialog">
        ...
        <div class="archive">
            ...
            <div class="archive-body">
                ...
                @foreach($data as $_year => $_months)
                    <div><a class="archive-year" href="#">{{ $_year }}</a>
                    <div class="month">
                    @foreach($_months as $_month => $_entries)
                        ...
                        @endphp
                        <div><a class="archive-month" href="#">{{ $_month }}</a>
                            <ul class="archive-detail">
                            @foreach($_entries as $_entry)
                                <li><a href="/{{ $_entry->category }}/{{ $_entry->date }}/{{ $_entry->slug }}">{{ $_entry->title }}</a></li>
                            @endforeach
                            </ul>
                        </div>
                    @endforeach
    ...
    $(document).ready(function(){
        $('a.archive-year').click(function(e){
            e.preventDefault();
            //$(e.target).parent().find('.month').toggle();
            $(this).parent().find('.month').toggle();
            //return false;
        });
        $('.archive-month').click(function(e){
            e.preventDefault();
            $(this).parent().find('.archive-detail').toggle();
        });
